...
## Javascript Assignments  [![Build Status](https://travis-ci.org/IamCyrek/js-assignments.svg?branch=branchForPullRrequest)](https://travis-ci.org/IamCyrek/js-assignments)
...
* Edit local README.md file and update all links (just replace all occurrences of `'IamCyrek'` with your account name).
...
```
* Open https://github.com/IamCyrek/js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
...
* Push your updates to github server and check if tests passed on [travis-ci](https://travis-ci.org/IamCyrek/js-assignments/builds).
